...
<section class="">
    <div class="row mt-3">
        <div class="col-md-8 ">
            <div class="card">
                <h5 class="text-center mt-2 mb-3 text-uppercase"><b>Add Skill</b></h5>
                    ...
                    <form method="POST" action="{{ route('skills.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="type" value="{{ old('type') }}" placeholder="like frontend backend devops mobile" class="form-control @error('type') is-invalid @enderror " id="type">
                                @error('type')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="functional_type" value="{{ old('functional_type') }}" placeholder="like oop or functional or procedural or structured or cloud or vcs etc" class="form-control @error('functional_type') is-invalid @enderror " id="functional_type">
